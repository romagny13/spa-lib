...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var chai_1 = __webpack_require__(5);
	var cache_1 = __webpack_require__(53);
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var chai_1 = __webpack_require__(5);
	var messenger_1 = __webpack_require__(55);
	/*
	 Should subscribe
	 Should publish
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request_1 = __webpack_require__(59);
	/*
	...
	describe('Http', function () {
	    ...
	    it('Should send', function (done) {
	        var request = new request_1.HttpRequest({ url: baseUrl + "/posts" });
	    ...
	    it('Should have an error on invalid url', function (done) {
	        var request = new request_1.HttpRequest({ url: baseUrl + "/n_o_t_f_o_u_n_d" });
	        http.send(request).then(function (response) {
	    ...
	    it('Should get response type', function (done) {
	        var request = new request_1.HttpRequest({ url: 'http://res.cloudinary.com/romagny13/image/upload/v1464052663/dotnet_oh0ryu.png', responseType: 'blob' });
	        http.send(request).then(function (response) {
	            chai_1.assert.isNotNull(response.body);
	            chai_1.assert.isTrue(response.body instanceof Blob);
	            done();
	        });
	    });
	    ...
	    it('Should post with form', function (done) {
	        var body = 'title=' + encodeURIComponent('My form article') + '&content=' + encodeURIComponent('my content');
	        var request = new request_1.HttpRequest({
	            method: 'POST',
	    ...
	    it('Should handle timeout', function (done) {
	        ...
	        http.send(request).then(function () {
	            chai_1.assert.fail();
	        }, function (response) {
	            chai_1.assert.equal(response.status, 0);
	            chai_1.assert.isOk('Ok');
	            done();
	        });
	    });
	    ...
	    it('Should handle progress', function (done) {
	        ...
	        http.send(request).then(function () {
	            chai_1.assert.isTrue(events.length > 0);
	            chai_1.assert.isNotNull(events[0]);
	            done();
	        }, function (response) {
	            chai_1.assert.fail();
	        });
	...
	var HttpRequest = (function () {
	    function HttpRequest(config) {
	        ...
	        */
	        // method
	        if (config.method) {
	            if (!util_2.isValidMethod(config.method)) {
	        ...
	        // progress
	        if (util_1.isFunction(config.progress)) {
	            this.progress = config.progress;
	        }
	        // timeout
	        if (util_1.isNumber(config.timeout)) {
	            this.timeout = config.timeout;
	        }
	        // credentials
	        if (util_1.isBoolean(config.credentials)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var chai_1 = __webpack_require__(5);
	var observables_1 = __webpack_require__(63);
	/*
	...
	*/
	describe('Observable', function () {
	    ...
	    it('Should push an item', function (done) {
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            chai_1.assert.equal(event, 'added');
	    ...
	    it('Should push items', function (done) {
	        var ev = [];
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            ev.push({ event: event, value: value, index: index });
	            if (ev.length === 3) {
	                chai_1.assert.equal(ev[0].event, 'added');
	                chai_1.assert.equal(ev[1].event, 'added');
	                chai_1.assert.equal(ev[2].event, 'added');
	                chai_1.assert.equal(ev[0].value, 'c');
	                chai_1.assert.equal(ev[1].value, 'd');
	                chai_1.assert.equal(ev[2].value, 'e');
	                chai_1.assert.equal(ev[0].index, 2);
	                chai_1.assert.equal(ev[1].index, 3);
	                chai_1.assert.equal(ev[2].index, 4);
	                done();
	            }
	        });
	        items.push('c', 'd', 'e');
	    });
	    it('Should insert (unshift) an item', function (done) {
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            chai_1.assert.equal(event, 'added');
	    ...
	    it('Should insert (unshift) items', function (done) {
	        var ev = [];
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            ...
	            if (ev.length === 3) {
	                ...
	                chai_1.assert.equal(ev[1].value, 'd');
	                chai_1.assert.equal(ev[2].value, 'e');
	                chai_1.assert.equal(ev[0].index, 0);
	                chai_1.assert.equal(ev[1].index, 0);
	                chai_1.assert.equal(ev[2].index, 0);
	                done();
	            }
	        });
	        items.unshift('c', 'd', 'e');
	    });
	    it('Should remove an item (splice)', function (done) {
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	    ...
	    it('Should remove items (splice)', function (done) {
	        var ev = [];
	        var items = ['a', 'b', 'c', 'd'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            ...
	            if (ev.length === 2) {
	                ...
	                chai_1.assert.equal(ev[0].event, 'removed');
	                chai_1.assert.equal(ev[1].event, 'removed');
	                chai_1.assert.equal(ev[0].value, 'b');
	                chai_1.assert.equal(ev[1].value, 'c');
	                chai_1.assert.equal(items.length, 2);
	                chai_1.assert.equal(items[0], 'a');
	                chai_1.assert.equal(items[1], 'd');
	                done();
	            }
	        });
	        items.splice(1, 2);
	    });
	    it('Should insert items (splice)', function (done) {
	        var ev = [];
	        var items = ['a', 'b'];
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            ...
	            if (ev.length === 3) {
	                ...
	                chai_1.assert.equal(ev[0].value, 'b');
	                chai_1.assert.equal(ev[1].value, 'c');
	                chai_1.assert.equal(ev[2].value, 'd');
	                chai_1.assert.equal(items.length, 3);
	                chai_1.assert.equal(items[0], 'a');
	                chai_1.assert.equal(items[1], 'c');
	                chai_1.assert.equal(items[2], 'd');
	                done();
	            }
	        });
	    ...
	    it('Should sort', function (done) {
	        ...
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            chai_1.assert.equal(event, 'sorted');
	            chai_1.assert.equal(value[0], 1);
	            chai_1.assert.equal(value[1], 2);
	            chai_1.assert.equal(value[2], 3);
	            done();
	        });
	        items.sort();
	    });
	    it('Should filter', function (done) {
	        ...
	        var o = new observables_1.ObservableArray(items);
	        o.subscribe(function (event, value, index) {
	            chai_1.assert.equal(event, 'filtered');
	            chai_1.assert.equal(value[0], 1);
	            chai_1.assert.equal(value[1], 2);
	            chai_1.assert.equal(value.length, 2);
	            done();
	        });
	    ...
	    it('Should reset filter', function (done) {
	        ...
	        o.subscribe(function (event, value, index) {
	            if (!isFiltered) {
	                ...
	                chai_1.assert.equal(event, 'filtered');
	                chai_1.assert.equal(value[0], 1);
	                chai_1.assert.equal(value[1], 3);
	                chai_1.assert.equal(value[2], 2);
	                chai_1.assert.equal(items.length, 3);
	                done();
	            }
	        });
	...
	var ObservableArray = (function () {
	    function ObservableArray(array) {
	        ...
	        array.splice = function (start, deleteCount) {
	            ...
	            if (!util_1.isNumber(start) || !util_1.isNumber(deleteCount)) {
	                return [];
	            }
	            var removedItems = [];
	            // remove
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var util_1 = __webpack_require__(47);
	var util_2 = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var util_1 = __webpack_require__(47);
	var form_config_1 = __webpack_require__(70);
	var form_element_config_1 = __webpack_require__(68);
	var form_error_1 = __webpack_require__(72);
	var form_submitted_response_1 = __webpack_require__(73);
	var form_element_1 = __webpack_require__(71);
	var util_2 = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var chai_1 = __webpack_require__(5);
	var stack_1 = __webpack_require__(77);
	describe('SpecializedStack', function () {
	    var stack, length;
	    before(function () {
	        stack = new stack_1.SpecializedStack();
	        stack.push(stack_1.SpecializedStackItemType.onResolved, function () { return 'resolved 1'; });
	        stack.push(stack_1.SpecializedStackItemType.onResolved, function () { return 'resolved 2'; });
	        stack.push(stack_1.SpecializedStackItemType.onResolved, function () { return 'resolved 3'; });
	        stack.push(stack_1.SpecializedStackItemType.onRejected, function () { return 'rejected 1'; });
	        stack.push(stack_1.SpecializedStackItemType.onRejected, function () { return 'rejected 2'; });
	        stack.push(stack_1.SpecializedStackItemType.onRejected, function () { return 'rejected 3'; });
	        stack.push(stack_1.SpecializedStackItemType.onRejected, function () { return 'rejected 4'; });
	        length = stack._stack.length;
	    });
	    it('Should find next resolved at index 0', function () {
	        var index = stack._getNextItemIndex(stack_1.SpecializedStackItemType.onResolved);
	        chai_1.assert.equal(index, 0);
	    });
	    it('Should find next rejected at index 3', function () {
	        var index = stack._getNextItemIndex(stack_1.SpecializedStackItemType.onRejected);
	        chai_1.assert.equal(index, 3);
	    });
	    it('Should move to next resolved item (0) return this item (shift)', function () {
	        var item = stack.next(stack_1.SpecializedStackItemType.onResolved);
	        var result = item.fn();
	        chai_1.assert.equal(result, 'resolved 1');
	    });
	    it('Should remove shift item from stack', function () {
	        var current = stack._stack.length;
	        chai_1.assert.equal(current, length - 1);
	    });
	    it('Should move to next resolved item (1) return this item (shift)', function () {
	        var item = stack.next(stack_1.SpecializedStackItemType.onResolved);
	        var result = item.fn();
	        chai_1.assert.equal(result, 'resolved 2');
	    });
	    it('Should remove shift item 2 from stack', function () {
	        var current = stack._stack.length;
	        chai_1.assert.equal(current, length - 2);
	    });
	    it('Should move to next rejected item return this item (shift), and ignore previous  resolved items', function () {
	        var item = stack.next(stack_1.SpecializedStackItemType.onRejected);
	        var result = item.fn();
	        chai_1.assert.equal(result, 'rejected 1');
	    });
	    it('Should remove rejected item (shift) from stack', function () {
	        var current = stack._stack.length;
	        chai_1.assert.equal(current, length - 4);
	    });
	    it('Should move to next rejected item return this item (shift)', function () {
	        var item = stack.next(stack_1.SpecializedStackItemType.onRejected);
	        var result = item.fn();
	        chai_1.assert.equal(result, 'rejected 2');
	    });
	    it('Should remove rejected item 2 (shift) from stack', function () {
	        var current = stack._stack.length;
	        chai_1.assert.equal(current, length - 5);
	    });
	    it('Should move to next resolved item and return undefined', function () {
	        var item = stack.next(stack_1.SpecializedStackItemType.onResolved);
	        chai_1.assert.equal(item, undefined);
	    });
	    it('Should have clear the stack', function () {
	        var current = stack._stack.length;
	        chai_1.assert.equal(current, 0);
	    });
	});
...
/***/ function(module, exports) {
	...
	})(SpecializedStackItemType = exports.SpecializedStackItemType || (exports.SpecializedStackItemType = {}));
	...
	exports.SpecializedStackItem = SpecializedStackItem;
	...
	exports.SpecializedStack = SpecializedStack;
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('TSPromise', function () {
	    describe('TSPromise', function () {
	        ...
	        it('Should catch exception from promise', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                throw r;
	            });
	        ...
	        it('Should catch exception from promise with catch', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                throw r;
	            });
	        ...
	        it('Should catch exception from then', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('p1 resolved');
	            });
	        ...
	        it('Should catch exception from then with catch', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('p1 resolved');
	            });
	        ...
	        it('Should catch exception from chained promise with catch', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('p1 resolved');
	            });
	        ...
	        it('Should ignore useless catch', function (done) {
	            var r = 'p1 resolved';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve(r);
	            });
	            p1.then(function (result) {
	                return result;
	            }).catch(function () { chai_1.assert.fail(); })
	                .catch(function () { chai_1.assert.fail(); })
	                .catch(function () { chai_1.assert.fail(); })
	                .catch(function () { chai_1.assert.fail(); })
	                .then(function (result) {
	        ...
	        it('Should ignore useless then', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve(r);
	            });
	            p1.then(function (result) {
	                throw r;
	            }).then(function () { chai_1.assert.fail(); })
	                .then(function () { chai_1.assert.fail(); })
	                .then(function () { chai_1.assert.fail(); })
	                .then(function () { chai_1.assert.fail(); })
	    ...
	    describe('all', function () {
	        ...
	        it('Should handle exception in promise', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                throw r;
	            });
	        ...
	        it('Should handle exception in then', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	        ...
	        it('Should handle exception and ignore useless then', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                throw r;
	            });
	        ...
	        it('Should handle return value and ignore useless catch', function (done) {
	            var r = 'return value';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	        ...
	        it('Should catch exception in then with catch', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	        ...
	        it('Should catch exception in then and ignore useless then', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	    ...
	    describe('race', function () {
	        ...
	        it('Should Return result from then', function (done) {
	            var r = 'return result';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	            ...
	            setTimeout(function () {
	                promise_1.TSPromise.race([p1, p2]).then(function (result) {
	                    return r;
	                }, function (reason) {
	                    chai_1.assert.equal(reason, r);
	                    done();
	        ...
	        it('Should Resolve handle exception', function (done) {
	            var r = 'error';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	        ...
	        it('Should Return result from then and handle next exception', function (done) {
	            var r = 'return result';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
	        ...
	        it('Should Return result from then and handle next exception and ignore then', function (done) {
	            var r = 'return result';
	            var p1 = new promise_1.TSPromise(function (resolve, reject) {
	                resolve('r1 resolved');
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function resolve(root, result) {
	    root._result = result;
	    var item = root._stack.next(stack_1.SpecializedStackItemType.onResolved);
	    if (item) {
	        item.fn();
	    }
	    else {
	...
	function reject(root, reason) {
	    root._reason = reason;
	    var item = root._stack.next(stack_1.SpecializedStackItemType.onRejected);
	    if (item) {
	        item.fn();
	    }
	    else {
	...
	function then(root, promise, onComplete, onRejection) {
	    var hasComplete = util_1.isFunction(onComplete), hasRejection = util_1.isFunction(onRejection);
	    ...
	    if (hasComplete) {
	        root._stack.push(stack_1.SpecializedStackItemType.onResolved, function () {
	            _doCompletion();
	        });
	    }
	    if (hasRejection) {
	        root._stack.push(stack_1.SpecializedStackItemType.onRejected, function () {
	            _doRejection();
	        });
	    }
	...
	var TSPromise = (function (_super) {
	    ...
	    function TSPromise(executor) {
	        var _this = _super.call(this) || this;
	        _this._stack = new stack_1.SpecializedStack();
	        try {
	            if (util_1.isFunction(executor)) {
	...
	exports.TSChildPromise = TSChildPromise;
